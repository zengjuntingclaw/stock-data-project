...
with open('_temp/final_check.py', 'w', encoding='utf-8') as f:
    f.write(script)

r = subprocess.run(['python', '_temp/final_check.py'], capture_output=True, text=True,
                   cwd='c:/Users/zengj/.qclaw/workspace/stock_data_project')
out = r.stdout + r.stderr
open('_temp/final_check_result.txt', 'w', encoding='utf-8').write(out)
print(out[:8000])
